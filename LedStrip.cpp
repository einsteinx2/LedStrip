...
LedStrip::LedStrip(int numLeds, int dataPin, int defaultBrightness, uint8_t startHue) {
    ...
    switch (dataPin) {
        ...
        #endif
        #if MAX_PIN > 14
        case 13: FastLED.addLeds<NEOPIXEL, 14>(leds, numLeds); break;
        #endif
        #if MAX_PIN > 15
        case 13: FastLED.addLeds<NEOPIXEL, 15>(leds, numLeds); break;
        #endif
        #if MAX_PIN > 16
        case 13: FastLED.addLeds<NEOPIXEL, 16>(leds, numLeds); break;
        #endif
        #if MAX_PIN > 17
        case 13: FastLED.addLeds<NEOPIXEL, 17>(leds, numLeds); break;
        #endif
        #if MAX_PIN > 18
        case 13: FastLED.addLeds<NEOPIXEL, 18>(leds, numLeds); break;
        #endif
        #if MAX_PIN > 19
        case 13: FastLED.addLeds<NEOPIXEL, 19>(leds, numLeds); break;
        #endif
        #if MAX_PIN > 20
        case 13: FastLED.addLeds<NEOPIXEL, 20>(leds, numLeds); break;
        #endif
    }
